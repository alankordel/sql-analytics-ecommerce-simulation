...
- `fato_vendas`: one row per order, with quantity, revenue, cost and profit.
...
updated through their natural keys and the fact table is reloaded inside a
transaction. Failures are rolled back and recorded in the audit table.
